    ...
    <div>
      <div className="container mx-auto pl-10">
        ...
        <div className="flex justify-between">
          ...
          <div className="">
            <div className="bg-[#FFFFFF] flex w-[405px] h-[50px] text-center mt-3 overflow-hidden mr-[100px] rounded-[10px] ">
              <select name="" id="" className="outline-none overflow-hidden">
                <option>
                  <span>Sort by:</span>
                  latest
                </option>
