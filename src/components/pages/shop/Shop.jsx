  ...
  return (
    <div className="mx-auto container w-[95%]">
      <div className="w-[1380px] h-[300px] rounded-[20px] bg-[#EFEBF5] mt-8 ml-10 flex">
        <div className=" w-[50%]">
          <h1 className=" text-6xl leading-[65px] font-semibold ml-[135px] mt-[85px] text-[#0A033C]">
            Eduvi Online <br />
            Book Shop
          </h1>
        </div>
      ...
      <div className=" w-[95%] h-[160vh] flex mt-[40px] ml-10">
        <div className="w-[30%]">
          <h1 className=" text-4xl leading-normal font-semibold  text-[#0A033C]">
            Popular Books
          </h1>
          {books.map((book) => (
            <div
              className="w-[400px] h-[140px] bg-white mt-5 rounded-xl flex"
              key={book.id}
            >
          ...
          <p className="text-xl leading-5 text-[#9C4DF4] font-medium mt-5 cursor-pointer">
            <Link to="/popularbooks">See more</Link>
          </p>
          <h1 className="text-4xl leading-normal font-semibold mt-10  text-[#0A033C]">
            New Arrivals
          </h1>
          {books.map((book) => (
            <div
        ...
        <div className="w-[70%]">
          ...
          <button
            ...
            onClick={() => handleFilterClicks("Kindergarten")}
          >
            Kindergarten
          </button>
          <button
            className="high_school"
            onClick={() => handleFilterClickh("High School")}
          >
            High School
          </button>
          <button
            className="college"
            onClick={() => handleFilterClickc("College")}
          >
            College
          </button>
          <div className="shop_serch_input">
            <div className="input_and_button_around">
              <input
                className="input_around_button"
                type="text"
                placeholder="Serach Class, Course, Book Name"
              />
              <button className="input_in_button">
                <img src={outline} alt="" />
              </button>
            </div>
            ...
            {filterShopData().map((item) => (
              <div className="shopping_img_divs" key={item.id}>
                ...
                <button
                  ...
                  onClick={() => setCart((prevCart) => [...prevCart, item])}
                >
                  <span>Click!</span>
                  <span>Read More</span>
                </button>
