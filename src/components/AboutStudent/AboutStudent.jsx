    ...
    <div className="container mx-auto w-[95%] md:flex justify-around items-center mt-10">
      ...
      <div>
        <div>
          ...
          <div>
            <button className="w-[185px] h-[60px] bg-[#9C4DF4] rounded-xl text-white mt-5 hover:bg-[#fff] duration-300 hover:text-black border-solid border-2 border-[#9C4DF4] ">
              Registation Now
            </button>
          </div>
        </div>
